...
const Navbar = () => {
    ...
    return (
        <div>
            <nav className="bg-white border-gray-300 dark:bg-gray-900 dark:border-gray-700">
                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="hidden w-full md:block md:w-auto" id="navbar-multi-level">
                        <ul className="flex flex-col font-small h-12 p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-gray-400 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            <li>
                                <NavLink to="/" className={({ isActive }) => `block mx-1 py-2 px-3 rounded-sm  md:p-0 md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:border-0 
                                ${isActive ? 'dark:text-blue-600 text-blue-600' : 'md:hover:text-blue-700 text-white'}
                               `} aria-current="page"> Home </NavLink>
                            </li>
                            <li>
                            <NavLink to="/Content" id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar" className={({ isActive }) => `flex items-center justify-between w-full py-2 px-3 hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto  md:dark:hover:text-blue-500 dark:focus:text-white dark:hover:bg-gray-700 md:dark:hover:bg-transparent ${isActive ? 'dark:text-blue-600 text-blue-600' : 'md:hover:text-blue-700 text-white'}`}>Courses<svg className="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4"/></svg>
                                ...
                                >
                                    ...
                                    <div className="py-1">
                                        <NavLink to="/Settings" className={({ isActive }) => `block py-2 px-3 rounded-sm  md:p-0 md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:border-0 
                                        ${isActive ? 'dark:text-blue-600 text-blue-600' : 'md:hover:text-blue-700 text-white'}
                                       `}>Settings </NavLink>
                                    </div>
                                </div>
                            ...
                            <li>
                                <NavLink to="/Courses" className={({ isActive }) => `block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent 
                                    ${isActive ? 'dark:text-blue-600 text-blue-600' : 'md:hover:text-blue-700 text-white'}
                                `}>
                                    Resources
                                </NavLink>
                            ...
                            <li>
                                <NavLink to="/Events"
                                    className={({ isActive }) => `block py-2 px-3 rounded-sm  md:p-0 md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:border-0 
                                    ${isActive ? 'dark:text-blue-600 text-blue-600' : 'md:hover:text-blue-700 text-white'}
                                    `}> Events </NavLink>
                            </li>
                            <li>
                                <NavLink to="/Contact" className={({ isActive }) => `block py-2 px-3 rounded-sm  md:p-0 md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent     text-gray-600 hover:bg-gray-100 md:hover:bg-transparent md:border-0 
                                ${isActive ? 'dark:text-blue-600 text-blue-600' : 'md:hover:text-blue-700 text-white'}
                                `}> Contact</NavLink>
                            </li>
                            <li>
                                 <span className="text-white md:hover:text-blue-700 cursor-pointer" onClick={() => toggleCart(!cartOpen)}> Cart({courses.length})</span>
                            </li>
                            <li>
                                {isLoggedIn ? <LoggedInComponent /> :
                                    <div className='flex  items-center'>
                                        ...
                                        <Link to="/Register">
                                            <button className="bg-[orange] px-2.5 py-1 rounded text-white hover:bg-[#85704a] cursor-pointer ml-2.5"> register </button>
                                        </Link>   
                                        <ThemeButton/>
                                    </div>}
                            </li>
    ...
    return (
        <div className="relative flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            <button type="button" onClick={() => setToggle(!toggle)} className="flex text-sm bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                ...
                <img className="w-8 h-8 rounded-full" src="/img/user.png" alt="user photo" />
            </button>
            {
                toggle && <UserMenu />
            }
