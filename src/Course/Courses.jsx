...
const courses = [
  ...
  },
  {
    ...
    imageUrl: "https://brandlogos.net/wp-content/uploads/2023/09/android-logo_brandlogos.net_v11va.png",
...
const Courses = () => {
  return (<>
    <h1 className='bg-cyan-700 text-3xl text-white p-1'> We Provide some Services !!!</h1>
    <div className='grid grid-cols-5 gap-2 p-8'>
    {courses.map((course,index) => <Card course={course} key={index} owner={"Shivam"} institute={"Triumph"} />)}
    </div>
    </>
  )
}
